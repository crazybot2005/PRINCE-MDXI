...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~YOKt3dFGKVaV5hqYlBPW", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
AUTO_READ_MESSAGES_EMOJIS: process.env.AUTO_READ_MESSAGES_EMOJIS || "🤍,🧡,💛,🤎,💙,💜,🩷,🩵", //Input Yours Custom...Can be one Emoji or Multiple Emojis Separated by Commas
